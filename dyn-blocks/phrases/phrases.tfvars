upload_content = [
  ...
  { content = "How you doing! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "yada, yada, yada! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
